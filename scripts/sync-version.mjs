 ...
 * That is not hypothetical here: `@cosyte/terminology@0.0.1` went to the registry on 2026-07-21
 * exporting `VERSION === "0.0.0"`, and `docs-content/installation.md` tells an installer to print
 * exactly that constant as the install smoke test. The `version` script (which the shared release
